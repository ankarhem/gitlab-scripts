...
while true; do
    ...
    CURL_OUT=$(curl -s -H "PRIVATE-TOKEN: $GITLAB_PRIVATE_TOKEN" "${BASE_PATH}api/v4/groups/$NAMESPACE/projects?search=$PROJECT_SEARCH_PARAM&per_page=999&page=$PAGE_COUNTER")
